...
public class Seed_Array_Generator
{
	public static int[][] Seed_Table_Engine()
	{
		...
		while(Seed_Num<=1||Seed_Num>=15000001)
		{
			System.out.println("Number of seeds must be an integer value, at least 2 and at most 15,000,000. Please input number of seeds:");
